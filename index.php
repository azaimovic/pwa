...
<?php
        ...
        <div class="row">
            <nav>
                <ul class="nav nav-fill">
                    ...
                    <?php echo '<li class="nav-item"><a class="nav-link" href="kategorija.php?id=sport">Berlin-sport</a></li>';
                    echo '<li class="nav-item"><a class="nav-link" href="kategorija.php?id=kultura">Kultur und show</a></li>';?>
    ...
    <main>
            ...
            <section style="margin-bottom:10px;">
                ...
                <div class="row">
                    <div class="text-center col-xl-12 padd">
                        <a class="naslovi" href="kategorija.php?id=sport">
                            <h2>Berlin-sport ></h2>
                        </a>
                    </div>
                </div>
        ...
        <div class="wrapper donji">
            <section style="margin-bottom:10px;">
                
                <div class="row">
                    <div class="text-center col-xl-12 padd">
                        <a class="naslovi" href="kategorija.php?id=kultura">
                            <h2 style="background-color:orange;">Kultur und show ></h2>
                        </a>
                    </div>
                </div>
